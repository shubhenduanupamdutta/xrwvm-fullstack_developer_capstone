...
from .restapis import analyze_review_sentiments, get_request, post_review, search_cars_request
...
# Code for the view
def get_inventory(request: HttpRequest, dealer_id: str) -> JsonResponse:
    data = request.GET
    if dealer_id:
        if "year" in data:
        ...
        cars = search_cars_request(endpoint)
